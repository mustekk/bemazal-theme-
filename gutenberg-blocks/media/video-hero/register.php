<?php
/**
 * Video Hero Block - Assets Loader
 *
...
add_action( 'wp_enqueue_scripts', function () {
    ...
    if ( ! has_block( 'bemazal/video-hero' ) ) {
        return;
    }

    $block_dir = get_stylesheet_directory() . '/gutenberg-blocks/media/video-hero';
    $block_url = get_stylesheet_directory_uri() . '/gutenberg-blocks/media/video-hero';

    // Enqueue block-specific styles
    // Block styles now bundled in main.css - HMR support enabled
    //     bemazal_enqueue_block_style( 'bemazal/video-hero', 'media/video-hero', 'video-hero-style' );
